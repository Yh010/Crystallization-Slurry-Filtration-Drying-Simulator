...
control_mode = 3.1;    % variable passed to controller.m function, useful to test multiple control strategies
                       % implemented control strategies:
                       % 0: open-loop
                       % 1: control strategy #3 in companion paper; example of end-point controller on temperature (works with u_nominal.V_slurry=3e-6 and u_nominal.c_slurry=250)
                       % 2: control strategy L1 in control paper
                       % 3.2: control strategy L2: soft-sensing" in control paper
                       % 3.3: control strategy L3: soft-sensing + RTO" in control paper
...
sampling_interval = .025; % sampling time for output measurements and states
